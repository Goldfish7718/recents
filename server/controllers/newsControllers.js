...
export const getLimelightResponse = async (req, res) => {
    try {
        ...
        const newsResponse = await axios.get(`https://newsapi.org/v2/everything?q=${parameters.q}&from=${parameters.from}&to=${parameters.to}&apiKey=${process.env.NEWS_API_KEY}`)
